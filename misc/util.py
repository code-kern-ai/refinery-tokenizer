...
def get_docs_from_db(tbl_entry: Any, vocab: Vocab) -> Dict[str, Doc]:
    if not tbl_entry.bytes or not tbl_entry.columns:
        raise ValueError(f"Can't find docbin for record {tbl_entry.id}")
